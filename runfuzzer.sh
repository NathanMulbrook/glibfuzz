...
then
    ...
    then
        for dir in */; do
            ...
            AFL_QEMU_PERSISTENT_GPR=1 AFL_QEMU_PERSISTENT_MEM=1 AFL_FORKSRV_INIT_TMOUT=60000  AFL_I_DONT_CARE_ABOUT_MISSING_CRASHES=1 /home/admin/software/fuzzing/AFLplusplus/afl-fuzz -Q -i input -o output ./$fuzzer
    fi
fi